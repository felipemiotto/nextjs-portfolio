  ...
  return (
    <main className="page-content pb-10">
      ...
      <div className="flex flex-col">
        ...
        <p>{dictionary.studies['big-o']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>        
        ...
        <p>{dictionary.studies.arrays} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['hash-map']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['two-pointers']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies.stack} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['binary-search']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['sliding-window']} Window - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['quick-sort']} Sort - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies.recurtion} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['linked-list']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>        
        ...
        <p>{dictionary.studies['doubly-linked-list']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies.deque} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies.trees} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies.tries} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        {/* <p>{dictionary.studies.backtracking} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p><Link className={styles.disabled} href={'/studies/heap-priority-queue'}>
          {dictionary.studies['heap-priority-queue']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span>
        </Link> */}
        <p>{dictionary.studies['heap-priority-queue']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies.intervals} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies.graph} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['dijkstra-algorithm']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['a-algorithm']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['dynamic-programming']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['kadanes-algorithm']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies.greedy} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['bit-manipulation']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['development-patterns']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['math-and-geometry']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p>
        ...
        <p>{dictionary.studies['turtoise-hare-algorithm']} - <span className={styles.notImplementedYet}>{notImplementedYet}</span></p></div>
    </main>
  )
}
